--Signature="43FBB84C50383C5A" 

--/**************************************************************************************************************/
--/**************************************************************************************************************/
--/****    Microsoft SQL Server Risk Assesment Program                                                       ****/
--/****                                                                                                      ****/
--/****    Report logins with security configuration issues for SQL Server 2008 instances                    ****/
--/****                                                                                                      ****/
--/****    created 16 July 2009 (wardp) - cloned from SQLSecurityBestPracticesChecks_2005.sql (CR 375891)    ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
