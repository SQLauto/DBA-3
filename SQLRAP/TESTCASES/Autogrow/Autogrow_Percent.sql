...
--/****     Oct 01, 2010: rajpo fixed the case for ReadonlyBIT  (Bug# 468882)                                ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
...
---for SQL Server 2000
	...
	WHERE [files].FileGrowth != 0 
	and files.FileStatus &0x100000 = 0x100000 )t 
	WHERE	          
