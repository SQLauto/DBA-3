--Signature="7CD554EC8E133CB9"

--/**************************************************************************************************************/
--/**************************************************************************************************************/
--/****    Microsoft SQL Server Risk Assesment Program                                                       ****/
--/****                                                                                                      ****/
--/****      Display configuration parameters different than default for Max worker threads config           ****/
--/****                                                                                                      ****/
--/****      11/03/2010 - Rajpo - Initial version convering from SQLBPA                                      ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
