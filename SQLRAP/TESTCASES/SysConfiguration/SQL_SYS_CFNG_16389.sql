...
--/****      10/15/09 - djaiswal - CR 379851 - Deprecated in SQL Server 2005, n/a for SQL Server 2008.                                                                                                ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
--/****                                                                                                      ****/
 ...
 if  9 = (select substring(@version, 1, 1))
     begin
         select  serverproperty('machinename') as 'Server Name',                                           
          ...
          where  a.configuration_id = 16389
